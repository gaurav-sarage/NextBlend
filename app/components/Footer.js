        ...
        <footer className="pt-2">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
                    {
                        footerNavs.map((item, idx) => (
                            <ul
                                ...
                                key={idx}
                            >
                                <h4 className="text-black hover:text-indigo-600 font-bold px-2 sm:px-6 sm:pb-2">
                                    {item.label}
                                </h4>
                                {
                                    item.items.map(((item, idx) => (
                                        <li key={idx}>
                                            <Link
                                                href={item.href}
                                                className="text-black hover:text-indigo-600 px-2 sm:px-6 duration-150"
                ...
                <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
                    <p className="text-black hover:text-indigo-600 font-semibold px-2 sm:px-6">© 2024 NextBlend Inc. All rights reserved.</p>
